...
Creamos un symlink para el transcriptoma de referencia.
```
ln -s /mnt/Timina/bioinfoII/rnaseq/BioProject_2023/examples_class/Human_cells_example/gencode.vM28.transcripts.fa.gz . 
```

Generamos el index de Kallisto.
```
module load kallisto/0.45.0 # cargar modulo de kallisto
kallisto index -i ./kallisto_quant/Hs_ref.kidx gencode.vM28.transcripts.fa.gz
```

Mandamos un job para generar el pseudoalineamiento con kallisto.
```
#!/bin/bash
...
kallisto quant -i ./kallisto_quant/Hs_ref.kidx -o ./kallisto_quant/SRR20114172 -t 25 ./data_trimmed/SRR20114172_1_trimmed.fastq.gz ./data_trimmed/SRR20114172_2_trimmed.fastq.gz
kallisto quant -i ./kallisto_quant/Hs_ref.kidx -o ./kallisto_quant/SRR20114173 -t 25 ./data_trimmed/SRR20114173_1_trimmed.fastq.gz ./data_trimmed/SRR20114173_2_trimmed.fastq.gz
kallisto quant -i ./kallisto_quant/Hs_ref.kidx -o ./kallisto_quant/SRR20114174 -t 25 ./data_trimmed/SRR20114174_1_trimmed.fastq.gz ./data_trimmed/SRR20114174_2_trimmed.fastq.gz
kallisto quant -i ./kallisto_quant/Hs_ref.kidx -o ./kallisto_quant/SRR20114175 -t 25 ./data_trimmed/SRR20114175_1_trimmed.fastq.gz ./data_trimmed/SRR20114175_2_trimmed.fastq.gz
kallisto quant -i ./kallisto_quant/Hs_ref.kidx -o ./kallisto_quant/SRR20114176 -t 25 ./data_trimmed/SRR20114176_1_trimmed.fastq.gz ./data_trimmed/SRR20114176_2_trimmed.fastq.gz
kallisto quant -i ./kallisto_quant/Hs_ref.kidx -o ./kallisto_quant/SRR20114177 -t 25 ./data_trimmed/SRR20114177_1_trimmed.fastq.gz ./data_trimmed/SRR20114177_2_trimmed.fastq.gz
kallisto quant -i ./kallisto_quant/Hs_ref.kidx -o ./kallisto_quant/SRR20114178 -t 25 ./data_trimmed/SRR20114178_1_trimmed.fastq.gz ./data_trimmed/SRR20114178_2_trimmed.fastq.gz
kallisto quant -i ./kallisto_quant/Hs_ref.kidx -o ./kallisto_quant/SRR20114179 -t 25 ./data_trimmed/SRR20114179_1_trimmed.fastq.gz ./data_trimmed/SRR20114179_2_trimmed.fastq.gz
kallisto quant -i ./kallisto_quant/Hs_ref.kidx -o ./kallisto_quant/SRR20114180 -t 25 ./data_trimmed/SRR20114180_1_trimmed.fastq.gz ./data_trimmed/SRR20114180_2_trimmed.fastq.gz
# I'm really bad at bash scripting sorry :C
```
...
Hs_metadata.tsv <- data.frame("SRA" =c("SRR20114180","SRR20114179", "SRR20114178", "SRR20114177", "SRR20114176",
...
Hs_files   <- file.path("./kallisto", Hs_samples$SRA,"abundance.tsv")
names(Hs_files) <- Hs_samples$SRA
```

```{r}
# Load table with trx id and gene id corrspondence
tx2gene <- read.csv("gencode.vM28.basic.trx_id-gene_id-no_ver.tsv",stringsAsFactors = F)

# Run tximport
# tx2gene links transcript IDs to gene IDs for summarization
txi.kallisto <- tximport(Hs_files, type = "kallisto", tx2gene = tx2gene, ignoreAfterBar=TRUE, ignoreTxVersion=TRUE)
...
write.table(all_de_gene_matrix_UP,file ="./all_DEG_kallisto_BlueLight.tsv", quote=FALSE, sep="\t")
# Extraer nombres
