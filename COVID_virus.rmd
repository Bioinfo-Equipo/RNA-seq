...
## de referencia
txdb = makeTxDbFromGFF(file = "downloads/gencode.v43.chr_patch_hapl_scaff.annotation.gtf.gz")
...
de interpretar i visualizar. Sin embargo, podemos apreciar como la muestra 
SRR20114175 es la más diferente de todas y la última en unirse al dendograma.
Posiblemente sea el outlier que identificamos en el PCA.
...
SRR20114175 difiere del resto en un cluster de genes.


Finalmente, podemos tener aún más resolución
