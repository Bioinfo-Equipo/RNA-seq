...
Alternativamente, podríamos crear el archuvo tx2gene a partir de un archivo de anotación
GTF/GFF3
...
```{r GO}
# resSigOrd = resSig[order(resSig$log2FoldChange, decreasing = TRUE), ]
# DEG = rownames(resSigOrd)
# 
# gostres = gost(query = DEG, organism = "hsapiens", significant = T, 
#                correction_method = "fdr", domain_scope = "custom", 
#                custom_bg = NULL, ordered_query = TRUE)


#write.table(as.factor(rownames(resSig)), file = "list.tsv", row.names = FALSE)
