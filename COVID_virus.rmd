...
Creamos un enlace simbólico para el transcriptoma de referencia en el directorio donde 
se correra kallisto, *i. e.*, en 
```/mnt/Timina/bioinfoII/rnaseq/BioProject_2023/rawData/COVID_virus```:
...
El pseudoalineamiento con kallisto se realizó para cada muestra con la siguiente
estructura:
